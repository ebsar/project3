        ...
        <div className='Footer-first-container'  >
            <div className='Footer-Right-Side'>
                <div className='Footer'  >
                    ...
                    <div className='Footer-Text-Container' data-aos='fade-right' >
                        ...
                        <div className='Footer-buttons-section' data-aos="fade-left" >
            ...
            </div><div className='images' data-aos="fade-right">
            </div>
